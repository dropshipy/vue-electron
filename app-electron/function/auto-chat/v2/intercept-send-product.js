...
const sendProductBtn =
  "#root > div.NsRmaKw72q > div.y4F28I1Q2N > div.GpaQAzyZwN > div > div.hfZWokKI0V > div.T9dwWBKsWn > div > div > div > div.shopee-react-checkbox-group > div > section > div.TpaWfMRThd > div > div > div > div:nth-child(1) > div.mi5pa49_U0 > div.NSGsJzUkfg > div.K1AEFgBLRQ.b5PN3ddbxd";

const interceptSendProduct = async ({ page, author_username }) => {
  try {
    ...
    await page.waitForSelector(sendProductBtn);
