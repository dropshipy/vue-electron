...
<template>
  <div v-if="downloadProgress" class="w-screen h-screen bg-whitesmoke flex flex-col items-center justify-center gap-1">
    <img :src="logoUrl" alt="logo" class="w-[75px] h-[75px] my-2 animate-wiggle-zoom" />
