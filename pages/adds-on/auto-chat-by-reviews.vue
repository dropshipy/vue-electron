...
<template>
  <Card class="w-full max-w-[540px] mx-auto">
    <div class="flex items-center justify-center gap-2">
      <Icon name="sidebar/adds-on/auto-chat-by-reviews" class="text-primary" />
    ...
    <Textfield v-model="targetLink" label="Link Produk/Ulasan" placeholder="Masukkan link produk/ulasan" class="mt-5" />
    <Textfield v-model="startPoint" type="number" label="Mulai Dari Ulasan Ke" placeholder="Masukkan mulai dari ulasan ke"
      class="mt-3" />
    <Textfield v-model="iteration" type="number" label="Total Chat" placeholder="Masukkan total chat" class="mt-3" />
    <Textfield v-model="templateChat" type="textarea" label="Template Chat" placeholder="Masukkan template chat"
      input-class="min-h-28" :max-height="200" class="mt-3" />
